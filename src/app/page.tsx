...
import { Zap, ShieldAlert, ShoppingBag, ArrowRight, Activity, MapPin } from "lucide-react"
      ...
      <section className="relative overflow-hidden rounded-3xl bg-card p-8 border border-primary/20 orange-glow">
        <div className="relative z-10 flex flex-col gap-4 max-w-lg">
          ...
          <p className="text-muted-foreground text-lg">
            Upload a photo of your electrical issue. Get an instant AI diagnosis and professional recommendations.
          </p>
          <Link href="/diagnose">
            <Button size="lg" className="mt-4 font-bold group">
              Scan Issue Now
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="hover:border-primary/50 transition-colors">
          <CardHeader>
            ...
            <CardDescription>AI Monitoring Status</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="hover:border-primary/50 transition-colors">
          <CardHeader>
            ...
            <CardTitle>Smart Store</CardTitle>
            <CardDescription>Recommended Products</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Based on your history, consider upgrading to a smart surge protector.
            </p>
            <Button variant="outline" className="w-full mt-4 text-xs">View Offers</Button>
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          <CardContent className="p-0">
            <div className="divide-y border-t border-border">
              ...
              <div className="p-4 flex items-center justify-between hover:bg-muted/50 transition-colors">
                <div className="flex flex-col">
                  <span className="font-medium">System Safety Check</span>
